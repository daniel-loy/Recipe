...
import mixingImage from './mixing.png'; // Update the import path
import coverimg from './receipy.png'; // Update the import path
...
function Navbar() {
  ...
  return (
    <div style={{ marginTop: "3rem" }}>
      <div>
        <form role="search" className="navbar navbar-expand-xl d-flex justify-content-center" style={{ position: "absolute", marginLeft: "55vh", marginTop: "25vh" }} onSubmit={handleNavigation}>
          <input
        ...
        <div className="navbar navbar-expand-xl d-flex justify-content-center" style={{ display: "flex", position: "absolute", marginTop: "8vh", marginLeft: "57vh" }}>
          <img src={mixingImage} alt="..." style={{ width: "7vw" }} />
          <h1 style={{ fontSize: "10vh" }} >Recipe</h1>
        </div>
        <img src={coverimg} alt="" style={{ width: "100%", height: "40vh" }} />
      </div>
      <nav className="navbar navbar-expand-xl d-flex justify-content-center">
        <div className="navbar navbar-expand-xl" style={{ position: "absolute", marginTop: "8vh" }}>
          <ul className="navbar-nav me-auto mb-2 mb-lg-0" id="navbarSupportedContent">
            <li className="nav-item" style={{ borderTop: "0.1vh solid green", borderBottom: "0.1vh solid green", paddingRight: "10vh" }}>
              <a className="nav-link active" aria-current="page" href="/Home" style={{ color: "black" }}>Home</a>
            </li>
            <li className="nav-item" style={{ borderTop: "0.1vh solid green", borderBottom: "0.1vh solid green" }}>
